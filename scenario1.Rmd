...
#scenario1
write.csv(df.pop,'./data/pop_scenario1.csv')
...
scenario1_singlesim = cbind(sdf$as,sdf$mn,sdf$pb,asw,mnw,pbw,weight.matrix,est2)

colnames(scenario1_singlesim) = c('as','mn','pb','asw','mnw','pbw','ps','ace')
write.csv(scenario1_singlesim,'./data/scenario1_singlesim.csv')
...
write.csv(man_trun,'./data/lower_truncation_mann_sce1.csv')
```
...
write.csv(man_trun,'./data/upper_truncation_mann_sce1.csv')
```
